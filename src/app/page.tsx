...
function TaleCard(tale: Tale) {
  return (
    <Link 
      href={tale.url}
      className="block p-4 rounded-lg transition-transform transition-colors md:hover:scale-105 md:hover:bg-gray-100 active:bg-gray-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
    >
